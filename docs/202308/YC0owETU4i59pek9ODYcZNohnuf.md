# 你的工作学习AI助手：通义听悟，如何通过AI能力颠覆飞书妙记？

> 来源：[https://superhuang.feishu.cn/docx/AoxId5jKWouzKIxp5VgcgOpcnQD](https://superhuang.feishu.cn/docx/AoxId5jKWouzKIxp5VgcgOpcnQD)
...
![](img/accceaf57aee40d7dde3b2046ce93d92.png)
...
1.  PC端打开B站视频，复制浏览器的视频链接

1.  打开视频下载网站：https://pv.vlogdownloader.com/，把上面的视频链接复制进去

1.  点击“开始解析”

![](img/204a7d16cb5c2ff9d695bb41b93a94d1.png)

1.  下面的网页会显示出解析出来的下载链接，在下载按钮上，右键另存为

![](img/dcfc1090b450c7ddf6df1b4ed9d2cf73.png)

1.  如果你的浏览器提示文件危险，可以选择仍然保留，接着就开始下载，下载速度还是很快的：

![](img/72e8ea92e6b208645d5a93545ca501c2.png)

1.  下载完成后，可以上传到阿里云盘，因为通义听悟是阿里系的产品，使用阿里云盘可以不消耗通义听悟的存储空间：

![](img/71ca2fddbe6ada08e01ec5ae21f8d228.png)

1.  接着打开通义听悟，绑定好阿里云盘：右上角头像---第三方应用管理。

![](img/750575bfcff59de2dee7021aaba31366.png)

1.  点击通义听悟里面的“上传音视频”---》“导入阿里云盘文件”，接着找到你刚才上传到阿里云盘的文件即可：

![](img/9e9a9331a08efcee96ab2f209cd5ec7b.png)

1.  点击“开始转写”，这里如果是2人对话，就选2人，区分发言人主要是更好的帮助识别

![](img/29068b29a776e417a67b89f352fc7d42.png)

1.  根据音视频时长，通常1-2分钟就完成转写了：

![](img/34d1b80b251ac8c3757dda88d3418ef9.png)

完成AI解析后，总的界面是这样的：

![](img/a652c56bb1b07c04e07734db1630f86f.png)
...
1.  在右侧的源代码界面，找到Audio Src=“xxx”

![](img/ae8748530b458eb767123343bd9020f1.png)

1.  双击复制，打开一个新窗口，粘贴后打开该链接

1.  在播放器下面的三个小点按钮那点击一下，选择下载

![](img/3731d4c4003fa7972f02e0f6b314296c.png)

1.  把这个mp3丢给通义听悟，几分钟，就可以开始看文字了。
...
![](img/ec0944e967cf8c994a5e74034ec1c671.png)

![](img/fd048e68b1343968c8a59b96e79da1fa.png)
...
![](img/447c7372fc60464c383ccc0732f19a79.png)
...
![](img/e409974b4dedc47401b4791351a1f20d.png)

除此之外呢，通义听悟还有章节速览的功能，对于辅助我做好Shownotes颇有帮助，可以借助来快速找到对应的内容段落：

![](img/d0b718b233d793641b8c436bc07e83b6.png)

## 第六.一些延展

我们可以发现，通义听悟的核心功能是，基于音频提炼的文字，做AI总结，目前包括摘要、章节自动划分、高亮提炼、问题回顾、待办事项提炼。

![](img/429287e0d51fb254388dbfb6fe876d47.png)

所以，我们可以在更多场景使用它：

1.  医患沟通录音 - 医生可以使用通义听悟转录病人描述病情的录音,帮助准确理解病情。

1.  面试录音分析 - HR可以上传面试录音,使用通义听悟生成文字及分析,帮助回顾和评估面试内容。

1.  谈判会议分析 - 商务团队可以上传谈判会议录音,使用关键词和段落分析帮助回顾谈判细节。

1.  法庭证词分析 - 律师可以上传法庭证词录音,使用通义听悟分析证词内容及逻辑关系。

1.  专业语音识别 - 可以上传专业领域的语音,使用通义听悟中的专有词汇功能提高识别准确率。

1.  音频内容检索 - 可以基于通义听悟的文字输出建立索引,从大量音频内容中检索需要的片段。

1.  音频内容翻译 - 可以上传外语音频,使用通义听悟的语音识别及翻译功能获得中英文双语内容。

1.  音频内容编辑 - 可以在通义听悟的文字输出基础上进行编辑,生成音频内容精简和改编版本。

1.  音频字幕生成 - 可以为视频、播客等音频内容自动生成字幕,方便内容回顾。
...
![](img/3e090926af29a8a984e36c42cd910599.png)
...
![](img/3aeca769ce6a2088a9f1e63a945d5fd6.png)

分别从不同维度使用AI做了内容摘要

1.  问题回顾

![](img/9c4eb51b96c3093b4db0f40b4b1e368d.png)
...
![](img/3e7e5876a151c16e4d9eeef51dd3981a.png)

1.  待办事项

![](img/7c9cddeb2777138694b5c6c48e7cd89b.png)
...
![](img/bc0658b7a58f808cb6f146ea8276a54c.png)

1.  自定义专属词汇

![](img/ccc292634e42fc16a709ab1acc2ad222.png)
...
![](img/22777ee9cbd266f6f981ea9b15fbc74d.png)

而飞书妙记必须使用PC网页端才能上传文件，使得你的文件必须要首先同步到电脑上，就很麻烦了。

1.  为了工作学习打造

![](img/a94d2b26a78279dce10c01452b07c181.png)

因此右侧给了一半的编辑区域，可以把正文部分的内容一键摘取过来，也可以把标记的内容一键摘取。

编辑器也做的挺丰富的，基本的功能也都支持。

1.  标注的部分会在时间轴上显示，方便用户查找

![](img/8abd1b1cc37d0e2e0ebe515a121f6f6f.png)

1.  时间轴会显示所处的段落

![](img/963606c9e15edeb5d7be62b05f247d3c.png)

1.  导出格式友好

![](img/5bd54ed61005190be0174eecfe598f2a.png)

飞书妙记只支持飞书文档、TXT之类的，麻烦得很。

通义听悟则直接支持主流的PDF、Word

![](img/d8949aef4b905a207d0136e5a210f5c6.png)
...
![](img/e49412fa78663ce7a295db0cbca72fde.png)
...
![](img/5c16ddd7a756e62376e73f88d7446582.png)

因为Super使用阿里云盘比较早，我的阿里云盘空间是1.79TB，足够足够了。

![](img/1c0bcc4b81634ad70c716145fe9e7c8a.png)
...
![](img/b6f1a6d4ee5bbacee9e2bdcbc9057a87.png)
...
1.  技术服务内部：阿里内部的呼叫中心会产生大量数据，如何用算法提供产品服务于场景的课题就产生了；

1.  云端产品演化：基于阿里云，使用API输出技术，其他的B端企业就可以使用这一服务，别客户集成使用；

1.  服务内部同事：公司同事出现例会，战略会，有音频整理的需求，就做了个网站，接着发现投资部门做背景调查也会用到，发布会会用到，年会的外籍员工比较多，也有“同声传译”的需求出现，加上大模型的出现，就开始变成产品化正式立项了。

1.  免费产品公测：做一款ToC产品，搜集用户反馈，探索用户真正的需求。
...
![](img/90516a534d9b3a9f6994fa5b6da2db9b.png)
...
![](img/ff442932993663adc788bda299961880.png)

2022年，阿里云在中国云市场占有率为36%，为市场最大者。

基于按使用量付费的模式，结合阿里云市场，可以快速打入到大客户。

![](img/e15d2e871c04dfd9ef5130137c59d1bd.png)
...
![](img/7984fdbc0f5e63f79af7410fb86c1ae4.png)
...
![](img/23abb39355d5aaf6b1f5d9e344c24470.png)

1.  转写时长可以增加获得难度，比如每天登录只能获得1小时转写时长，重度使用用户可以通过邀请好友获得转写时长，或者是付费进行购买转写时长。
...
1.  支持更多音频输入来源：目前仅限于本地上传音频文件，如果可以直接解析网页里的音频链接，会更加方便，比如BiBiGPT可以丢链接直接获得总结的结果：

![](img/b4cfe358401477df92dd83c9fe40304b.png)

我们看播客、视频场景，是需要在通义听悟里面上传文件的，如果可以自动解析链接里的音视频内容，就又大幅简化了用户的操作流程。

1.  打通云存储服务：除了阿里云盘，也可以增加更多云盘的支持，比如夸克网盘等常用的云盘，扩展用户场景，夸克也同样是阿里系产品。

![](img/015fa749c7fa0264f107012cce7fa6ca.png)

1.  用户体系打通：现在通义听悟是一个独立产品，也是个比较轻量化的产品，可以考虑和flomo一样，像水那样融入到其他产品里面。除了钉钉，也可以考虑找到有类似场景的产品融合。

1.  提供个性化定制功能：当前支持用户自定义专有词汇，后面可以考虑增加不同的模型，比如美剧字幕模型、专业英语考试模型等等。

1.  增加快捷键：可以增加一些快捷键，提高操作效率。

![](img/01a461dc00c8976226ad73ee7b2ff46e.png)

比如选择文案后弹出的窗口，我还需要移动鼠标去选择功能操作，这里可以增加一个快捷键，免去了移动鼠标的动作

1.  输出格式多样化：目前的输出还是以文字为主，可以考虑增加思维导图的模式，对于用户理解全文结构会更加清晰直观。

1.  开放API接口：现在需要进入到帮助页面才能找到，可以在官网首页更加直观的展示入口，鼓励开发者调用。

1.  探索新商业模式：除了常规的接口调用后付费模式、可能的付费购买转写时长模式，还可以增加比如企业的语音监测等模式。

1.  国际化：面向东南亚、欧美、非洲市场，开拓海外。

# 07 总结

今天在即刻上看到吕立青放出来的腾讯会议截图，在会议摘要上已经做到不输通义听悟的程度了。技术上，不觉得通义听悟有很强的护城河：

![](img/5c23d06dc70abe453406fe8c238a42e1.png)
...
![](img/12166639d64e1d4eac09ff7b5b5d4a87.png)

![](img/83d8d1d77d5fbcceba4d77af795832f6.png)
