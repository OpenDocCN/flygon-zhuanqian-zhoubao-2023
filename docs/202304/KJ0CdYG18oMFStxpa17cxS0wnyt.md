...
1.  写一篇吸引人的文案和对应的配图发布在公众号上 @令狐峰

1.  优化Ai写作的课程内容@令狐峰

1.  产品购买权益和分销逻辑的设定@令狐峰

1.  把以前抖音搜索课程中的内容，单独列出大纲 @hawli

1.  小鹅通：课程列表页设计课程的图片第一个版本@hawli

1.  设计整个购买和服务流程设计@hawli

1.  Notion Ai的账号自动注册的脚本，批量注册Notion Ai账号，并且自动开通会员 @技术

于是整个下午我们都在做各自的任务，并且紧张的忙碌着，最终在下午7.30完成所有工作，紧张而又忙碌的6个小时。下面是我们过程中的一些心得：

### 写公众号文案心得

1.  标题无比重要，标题直接决定了点击率，讨论之后我们打算在下面二个标题之间选择，因为时间紧张，最终决定选择了第一个标题，后面想想选择标题2效果更好，截止到当天晚上24点文章总共被分享了142次。

1.  “不用科学上网，使用GPT的方法”

1.  “不用会封号，使用GPT的方法”

1.  chatgpt目前在国内还是属于敏感的话题，所以在我们使用gpt来代替，避免文章被封

1.  文档中为了直观，加入了视频教程，录屏的工具是芦笋录屏，非常好用： https://lusun.com/

1.  注意评论区的回复，及时的去回复大家的问题

![](img/4dab26865e2ec066c1da0de91386953b.png)

### 优化课目录心得

1.  要把课程内容做的更加细致一些，课程目录看起来更加有诱惑力一些，至少保证看一眼就知道内容是讲什么的，并且吸引人。

1.  起一个好听的课程名字：人人都能学会的Ai写作课

![](img/3538b659f8ea8a0be4c444f6ed74d83d.png)

### 课程上架心得

1.  如果要做知识付费建议提前储备小鹅通的专业版账号，找生财里面的码叔买有优惠

1.  图片设计：使用的创客贴的模板，快速创建了课程海报 https://www.chuangkit.com/

1.  利用好优惠券：原价2399，给用户设置领取一个2000的优惠券，只要399
...
1.  找到邮箱接码平台，用来批量生成邮箱和接受邮件验证码

1.  写好python脚本自动注册Notion账号

1.  存储好Notion的账号和密码到数据库
...
1.  公众号中有不少错别字，复盘的时候才看见

1.  图片做的比较粗糙，看起来一版本

1.  因为要交付的东西太多，工具的权限开通和Notion ai账号的交付，还陆续交付中

1.  课程的详情页比较粗糙，导致流失了不少客户

1.  自动注册Noiton的账号，有部分账号的还需要选择几个选项才能进入Ai模块，体验上待改进
