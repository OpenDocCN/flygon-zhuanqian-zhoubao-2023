...
1.  如何进入？直接微信搜一搜： 微信指数 即可。

1.  如何使用？输入特定关键词，比如 图片，等待一下，小程序会自动提示相关联的搜索词。

1.  点击对应的关键词进去，就能看到具体关键词，以及每天的搜索指数了。

1.  另外，还可以对几个关键词添加对比，点击截图的 “添加对比词”即可。
...
1.  微信搜索，5118，找到公众号，关注即可。

1.  找到菜单栏 快速查询==>商机挖掘，输入关键词，比如图片工具，找到“长尾需求”，挖掘关键词。

1.  需要注意的是：指数值是否准确，不重要，重要的是，观察一下指数变化的趋势即可。
