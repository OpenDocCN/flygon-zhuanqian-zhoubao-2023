...
*   生财圈友 @码叔编程 的 AI会话存档插件：导出 ChatGPT 会话为 PDF等多格式到本地；
...
1.  ChatGPT 是魔法百宝箱，密码就是 Prompts，这是流量密码，也是财富密码。

1.  浏览器插件只是一种产品形态，开放了 API ，可能性就太多了。一句 Prompt 等于一个 Mini tool，一套 Prompts 等于一个 Mini SAAS；

1.  思考符合自己业务需求的场景，大胆用 ChatGPT 为自己和业务赋能；

1.  最后也是最重要：鉴于原生体验、内容安全，建议创业者们出海，这也是我们做英文工具站的意义。
