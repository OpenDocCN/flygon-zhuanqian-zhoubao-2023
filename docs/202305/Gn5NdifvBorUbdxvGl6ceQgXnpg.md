# 新手小白如何借助生财小航海每月多赚 2 万元（附：小航海项目筛选模型）

> 来源：[https://wchekk4hs9.feishu.cn/docx/Gn5NdifvBorUbdxvGl6ceQgXnpg](https://wchekk4hs9.feishu.cn/docx/Gn5NdifvBorUbdxvGl6ceQgXnpg)
...
1.  先随便找个词根，那时我刚好在某位圈友（记不清）的公众号看到了帮外卖商家删差评赚取服务费的项目

1.  于是我在 5118 搜索了相关的百度数据，百度上有很多关于这方面的新闻，所以收录页比较多，几乎和搜索流量差不多。

1.  但是本着在一个流量池不是蓝海，在另一个流量池可能就是蓝海想法（那时我在蓝海挖掘航海群里特意向小排老师请教过这个问题）

1.  我又搜索了小红书的数据，发现只有不到 10 条笔记，但是搜索流量并不低（具体多少确实忘记了，很久的事了）

1.  之后，我又经历了差不多一年时间的懒惰，才开始着手去行动。
...
![](img/cad83aa28ac9f284a1724fb119195a0a.png)

![](img/9e89d0525ad3a82090cd65bfaadbe2c8.png)
...
![](img/1a32a14f0191bddab424004f50e4278a.png)

下面是 3 月份的总收益：

从小红书来源的客户收益 4800 元，从微信直加来源的客户收益 13000，用户推荐的客户收益 640 元，累计收益约 18000+元，环比增长率 20%左右。

![](img/7d1a26e437b3b664fc78914caa5b7a62.png)

因此，这个项目到目前也算是步入了增长期，目前的重点就是放大收益。

我目前的规划有以下几个：

1.  增加小红书发帖数量及账号数量，争取能在小红书搜索相关关键词时，Top50 内有 40 条都是我的笔记，做到局部垄断单一流量池的局面；

1.  参加抖音 SEO 小航海，尝试以同样的操作垄断抖音相关流量

1.  再以同样的方式尝试垄断快手、微信搜一搜、知乎等其他 seo 相关的的流量

1.  针对现有的客户，扩展其他变现场景。如找做外卖运营的圈友合作，将项目调整下。（ps：我们现在拥有外卖商家私域流量约 3w+，合作过的客户有 200+，有相关资源的可以对接一下）

1.  了解其他行业如电商行业的差评是否有同样的需求
...
1.  初入生财：没日没夜地看几天精华帖。发现大佬如此之多、赚钱方法如此之多、项目如此之多，发誓今年一定要借助生财赚到自己的第一桶金。但当时的我只是"看"精华帖，至于这些精华帖对自己而言除了感官的刺激还代表着什么却一概不知。

1.  筛选项目：在看许多精华帖后，想立刻开始实战一个项目，于是在项目库挑选、筛查各种项目。这个项目做的人太多了，竞争太大；那个项目已经红海，收益不高；另一个项目天花板太低了，这都落伍的玩法了等等等，这都是我当时的 Filter。

1.  尝试动手：当真的确定好一个看起来似乎完美的项目后，却始终不敢开始行动、把手弄脏。原因如担心赚不到钱、担心还没开始风口就过去，亦或是从未相信过自己能够赚到钱

1.  更加焦虑：当真的跑通之后，如何放大收益？招人？投付费广告？还是其他的？那么多方式难以选择与自己项目更加匹配的。
...
1.  流量：在小红书铺设关键词，来获取搜索流量

1.  产品：产品是个人微信号为载体的虚拟课件和其他相关课件

1.  变现：变现是直接通过微信售卖

当我们外卖 cps 相关帖子时，同样按照模型拆解，可以得到以下三部分信息：

1.  流量：通过投放公众号广告、外卖小哥广告来获取流量

1.  产品：产品是以公众号为载体搭建的领券小程序

1.  变现：变现是让用户直接在公众号和小程序领券下单

当我们拆解完两篇帖子后，会得到共计 6 个模块。当我们要去做其他项目时，其实只需要把这几个模块拼在一起，就能得到一个新的模式。

比如，我们同样去做小红书资料引流：

1.  流量：流量可以以小红书搜索流量为主，再去测试投放公众号广告，毕竟微信指数显示微信搜索流量同样很大

1.  产品：产品我们可以以公众号为载体，同时加上微信小程序下单自动发货，这样能够节省很大的人力成本
...
1.  关键词——通过关键词链接到用户。如 SEO，我的规划就是做关键词相关的流量

1.  关系链——通过关系链链接到用户。如微信裂变、如做外卖 cps 在美团商家群发引流帖子就是用了「商家」这个关系链。

1.  算法推荐——让算法将自己推荐给目标用户。如短视频平台。

1.  有人会问：知道了，然后呢？ 然后很简单，你只需要举一反三，比如学会如何寻找关键词、如何铺设关键词，那是否就掌握了「关键词」的流量密码？
...
![](img/bedf12964855a0b3662a6426752178ff.png)
...
*   [ ] 一句话描述：如：在小红书引流搜索流量，卖虚拟资料变现

*   [ ] 是否能创造全局增量、所有角色都能获得价值：这个问题来源于刘润老师的文章，在我看来在初阶生财可以不用考虑，我也只是当成理想目标在寻找。

*   [ ] 是否是违法违规、损人利己、钻规则漏洞的项目：这个问题来源于我以前的经历。如果你做过薅羊毛、灰产相关项目，就该知道每月换一个项目、和平台规则对抗是多么痛苦的一件事。

*   [ ] 风险评估：主要用于评估风险

*   [ ] 风险概率：这个项目有多大概率有风险？比如会被请喝茶？比如外卖删差评就是灰产，有风险概率。

*   [ ] 风险程度：如果有风险的话，损失程度如何？是只会损失盈利？还是成本也会损失？亦或是损害名誉、倾家荡产？比如做割韭菜的 IP 就会损害名誉及信用。

*   [ ] 收益评估：主要用于评估收益

*   [ ] 反馈周期：多久见到第一块钱？收获正反馈？对新手来说正反馈很重要。

*   [ ] 最高收益：你预测这个项目最多能赚多少钱？天花板多高？

*   [ ] 附加价值：主要用于评估项目的积累。

*   [ ] 是否能积累到货源、资源。比如做无货源电商就可以积累到一些性价比较高的货源。

*   [ ] 是否能积累到人脉、粉丝。比如做外卖删差评就可以积累到私域流量粉丝

*   [ ] 是否能积累到专业能力。比如做英文工具站就可以积累到编程和搭建网站的能力

*   [ ] 是否具有杠杆效应&复利效应&复购效应

*   [ ] 杠杆效应：这个项目能否利用到杠杆？商业杠杆有四种：劳动力、资金、影响力以及可 0 边际成本复制的产品。

*   [ ] 复利效应：这个项目是否存在复利效应？简单点讲：今天做的事是否会让明天的你更轻松？或者更赚钱？

*   [ ] 复购效应：这个项目是否会产生复购？比如外卖删差评的复购效应很明显，几乎合作过的客户都会继续合作。

*   [ ] 市场评估：

*   [ ] 持续周期：这个项目会存在多久？其实以我们的视野肯定看不到全貌，但是我们也可以给项目设置一个大致区间，比如 1 年、3 年、10 年以上、30 年以上

*   [ ] 市场渗透率：当前需求/需求总量，主要针对需求端、用于判断是否是增量市场。

*   [ ] 供需状态：当前供给/当前需求。主要针对供给端、用于判断是否是红海。

*   [ ] 优化空间：产品优化空间有多大？如果市场同行都特别强，而自己又特别弱，那可以再斟酌斟酌。

*   [ ] 能力评估：主要评估自己是否有能力和资源来做。

*   [ ] 所需技能：是否重新学习至少 1 个技能？

*   [ ] 是否需要重新学习行业知识？比如你从未做过淘宝，要去做淘宝无货源，那就需要从头学习行业知识。再比如从未出海看过，那英文工具站对你来说显然比较困难。

*   [ ] 是否需要重新学习一个技能？如果你从未剪过视频，那去做视频号带货就需要重新学习剪辑。

*   [ ] 所需资源：是否需要粉丝货源、已有产品等

*   [ ] 是否需要有私域流量粉丝。比如快团团要求有粉丝。

*   [ ] 是否需要有货源。比如闲鱼等电商项目，如果有货源就会更好。

*   [ ] 是否需要有自己的变现产品承接。比如抖音 SEO 的航海，如果你现在什么产品都没有，参加这个航海只是能学到 1 了个引流方法，但依旧需要有自己的产品承接。

*   [ ] 所需时间：

*   [ ] 每天耗时多久？比如有些项目需要全天、有些项目每天只需要 2 个小时。对于部分还有主业的圈友来说显然只能选择 2h 的项目。

*   [ ] 是否需要随时紧盯？比如电商客服。对于还有主业的圈友来说就不合适。

*   [ ] 所需成本：首次投入大概多少

*   [ ] 比如有些圈友是学生，一个店铺 5000 保证金确实不好拿出手。
...
1.  先筛选自己的原则。比如违法违纪的决不能干，所以先筛选

1.  再筛选自己的能力。将上述能力评估的每一项都根据自己目前真实情况筛选一下

1.  再筛选收益。先筛选收益后筛选市场的原因是，一个项目能否赚到钱更取决于自己的能力、而非市场多大，至少对目前的我来说是这样的。

1.  最后筛选市场。

筛选完之后你可能会得到一个或几个项目，如果一个项目都没有过滤到，那么你需要考虑三个问题：

1.  是否是自己的条件太苛刻？filter 太多？可以尝试降低一些标准或者取消一些条件。毕竟 filter 太多是找不到项目的第一个原因（源自小排老师文章 https://wx.zsxq.com/dweb2/index/topic_detail/185255552411582）

1.  是否是看到的项目太少？可以再去项目库翻翻、多看一些项目

1.  是否是对项目不了解？所以在填入对应项目的参数时不正确？如果是，可以再去详细了解一下圈友们的帖子。
...
1.  用电脑打开筛选模型：https://wchekk4hs9.feishu.cn/base/TpsBbwxhYaplTWsUGmpc6k6QnXc

1.  点击右上角三个点-创建副本，到自己的飞书文档中

1.  根据自己目前的情况，筛选模型中每个参数

* * *

请注意：

1.  模型中所有项目的参数均为我个人认知，你可以根据自己的认知和情况，修改每个项目的参数

1.  模型中所有参数均为我个人认为比较重要的参数，你可以根据自己的情况，新增或修改每个参数
...
1.  矩阵：通过更多账号来形成局部垄断，获取同一个流量渠道的更多流量；

1.  投放：通过投放 ROI 为正的广告来获取更多流量。
...
1.  业务本身：放大业务本身，简单点讲就是放大当前业务的盈利。

1.  其他业务：再做其他关联业务，简单点讲就是将当前业务迁移、或扩建。
...
*   收益 = 客单价 x 支付率 x 咨询率 x 添加好友人数

*   收益 = 客单价 x 支付率 x 咨询率 x 添加率 x 小红书引流触达数

*   收益 = 客单价 x 支付率 x 咨询率 x 添加率 x 小红书引流触达率 x 私信人数

*   收益 = 客单价 x 支付率 x 咨询率 x 添加率 x 小红书引流触达率 x 私信率 x 阅读量
...
*   把支付率提高：想办法增加咨询人数的支付率，从而提高收益。比如每隔 2 小时给咨询过的客户催单。

*   把咨询率提高：提高添加好友后的咨询率。比如通过主动私聊，提升咨询率。

*   把添加率提高：提升私信发联系方式的转化率。比如使用自动回复软件做到 1 分钟内回复用户私信消息。

*   把私信率提高：提升浏览用户的私信率。比如可以在评论区引导用户私信、也可以对感兴趣的用户主动私信。
...
*   阅读量 = 推荐阅读量 + 搜索阅读量 + 同城阅读量

*   阅读量 = 推荐阅读量 + 单个关键词流量 x 点击率 x 单篇帖子覆盖关键词数量 x 单账号帖子数量 x 人均账号数 x 客服人数

*   单个关键词流量：这个因素不受我们控制，可以忽略。

*   点击率：通过优化图片、优化标题来提升点击率

*   单篇帖子覆盖关键词数量：通过覆盖更多关键词来获得更多关键词的流量

*   单账号帖子数量：很好理解，多发帖子就对了

*   人均账号数：多运营一些账号。其实就是所谓的矩阵打法
...
*   客服数量 = 当前客服数量 + （A 渠道招聘数量 + B 渠道招聘数量）

*   客服数量 = 当前客服数量 + A 渠道招聘数量 + B 渠道沟通人数 x 面试率 x 入职率
...
*   假如你是做小红书幼师资料的，你也可以找人开个幼师升级课、幼师考证课，以此增加变现收益。

*   假如你是做淘宝蓝海的，你也可以在 pdd 卖同样的产品，以此增加变现收益。
...
1.  针对同一类型用户增加上下游其他业务：如小红书幼师资料做幼师考证课程

1.  针对不同类型用户做同样业务：如本地相亲的新开展中老年相亲业务

1.  变卖流量：帮他人打广告。如做直播带货的除了带货本身，还可以在场景里加入其他曝光广告

1.  卖影响力：贴牌、代理、加盟

1.  培训：卖商业模式，把同样的项目卖给别人一起做
...
1.  你可以利用好现有流量，结合他人的课程做幼师考证课程；

1.  也可以将同样的项目思路用到「考公、考证」等其他项目；

1.  变卖流量：如果你没有精力再去做幼师考证课程，也可以给做课程的人导流，卖流量

1.  卖影响力：甚至，你可以成立一个资料品牌，招收合伙人一起做这件事

1.  培训：当然，如果没有品牌、也不想维护品牌，可以直接把当前的项目给卖掉，做培训
...
1.  你可以利用好现有的流量，和商家合作做霸王餐业务；

1.  也可以针对现有流量，增加其他的业务场景如打车返利、淘宝客等；

1.  变卖流量：你可以在小程序或公众号给别人打广告。

1.  卖影响力：你可以设置分佣，招募代理。

1.  培训：你可以将整个项目卖给同样想创业的人。
...
1.  可以和婚纱店、金银店合作，帮他们引流要结婚的新人

1.  可以开展中老年相亲业务

1.  变卖流量：可以在小纸条背面印上本地其他商家的广告

1.  卖影响力：可以在其他地区利用品牌影响力招募合伙人

1.  培训：可以将整个业务卖给其他地区的人一起做
...
1.  首先我们假设现在已经跑通、并获得一些资源。毕竟能做到这一步要么已经积累了一波粉丝，要么积累了一套货源。

1.  粉丝=流量，货源=产品

1.  当你拥有了流量，那么就可以考虑针对同一用户群体，扩展其他业务

1.  当你拥有了产品，就可以考虑挖掘其他类型的流量，增加用户覆盖范围
...
1.  第一阶段，初入生财-锻造武器：多刷精华帖、并拆解为不同的武器，可以直接用表格记录。

1.  第二阶段，筛选项目-明确战场：根据自己的经验搭建或直接使用我为你搭建好的项目库筛选模型，筛选更适合更匹配自己的项目。

1.  第三阶段，勇敢行动-把手弄脏：开始行动→遇到问题→解决问题

1.  第四阶段，放大项目-增加盈利：首先根据增长模型想办法扩展「业务本身」的盈利，其次筛选适合自己项目的业务扩展方式，增加其他盈利。
...
1.  蓝海项目挖掘蓝海复盘 https://t.zsxq.com/0dAVx4L1I

1.  如何判断自己的创业项目好不好？https://wx.zsxq.com/dweb2/index/topic_detail/182844115125482

1.  判断项目行不行的极简方法 https://wx.zsxq.com/dweb2/index/topic_detail/184214255522812

1.  如何分析一个互联网项目的可行性？能否值得去做？https://wx.zsxq.com/dweb2/index/topic_detail/241158845554181

1.  为什么你进了「生财有术」，还是赚不到钱？https://wx.zsxq.com/dweb2/index/topic_detail/185255552411582

1.  5 月小航海项目筛选模型 https://wchekk4hs9.feishu.cn/base/TpsBbwxhYaplTWsUGmpc6k6QnXc