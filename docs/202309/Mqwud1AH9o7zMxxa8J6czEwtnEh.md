...
> 来源：[https://nivut760ftk.feishu.cn/docx/Mqwud1AH9o7zMxxa8J6czEwtnEh](https://nivut760ftk.feishu.cn/docx/Mqwud1AH9o7zMxxa8J6czEwtnEh)
...
![](img/ee3a74b2ac3c38588e832f970340273c.png)
...
![](img/473aab56d886f16b94881ada3a17e38b.png)
...
![](img/65f96681818ead368d764d4aed8ca77e.png)
...
![](img/cc11b8dbb57b73728823e8204b0fa29f.png)
...
![](img/beaa6f397c6e862311265dae1b17294c.png)

激动得马上跟圈友反馈

![](img/07322ddf12c5a51735b44bac30d4a1de.png)
...
![](img/dfbdb2a349e35bb55644b1b4042a5414.png)

会出现很多像这样的页面

![](img/a130b21e6a9e9434cbd4d1dd4bab836c.png)

像这么多的图片，我要依据什么核心点来选呢？

很简单的，只要他的封面足够吸引我，让我看了他的图后，都有想去报名的冲动，这种图就要截图保存下来

![](img/a8233a42fd2d0f31cf0e539f8c41f4f7.png)
...
![](img/28650f6eb7d6bb28488dff9ab1d94bc7.png)
...
![](img/173b06b3560eb830ead7fc1cddb549f0.png)

然后点击下面的编辑这，裁剪成3:4的尺寸比例

![](img/acb35909381687826148fa9295d2e8f8.png)
...
![](img/e169e69b3103a6cdb2c080a9811e6acd.png)
...
![](img/f9d263f866a744c0474ed49e293e5fab.png)

其他多出来的部分我都不想要，只要最下面的那张图，然后我就用手机相册，把它做了个简单的裁剪

![](img/dd757e29172fae7dd2a53cd4bf46fe7f.png)

考虑到不想被平台抓到我是搬运的，于是我就把这张图片，弄成镜像，把它反了过来

![](img/90b2d8f4d6acd2fbf49cd0460db103d5.png)
...
![](img/446c4a0ec9f93377e502ae83db9bb7ff.png)

点击自定义后，添加刚刚的图片，它会自动给你抠图的，你就取消掉，点确定就完成了

![](img/5c2f5c7d20d80135ee3c7f0a1ce645a0.png)

这是完成后的图片，然后双指往两个相反的方向拉开就会放大，相反则缩小

![](img/c2264ed3f8188a67be869fbbe80cb363.png)

这是我放好之后的位置，你们参考下

![](img/54454d91de19918bd4e4d9cf52e399fd.png)

制作好了下面这张图后，像画圈圈的这块地方，该怎么制作呢？

![](img/9f12618bd28db313c3ef038d55e7f40c.png)

来，我们继续

我又回到了小红书上，换个关键词来搜索，“汤姆和杰瑞”，然后找到了像这样的两张图片

![](img/72b2527c017ebd57c8aff964b31b0955.png)

按照刚刚找贴纸功能的那个方法，把图片给放上去，摆正好位置后，就做成像这样的，你们参考下

![](img/5aa6c24388aa7d383326e9f833dedc0b.png)

是不是有点像了对吧

OK，那画圈中的这个“爱心”表情在哪弄的

![](img/ad03231e99856edb55bd4571f381ffee.png)

找到这个贴纸功能

然后在搜索框那，搜索“爱心”两个字，就会出现一排的爱心，你任选一个好看的放上去就行了

![](img/e61df681c0bb26d54ba4e7683d71aa2a.png)

是不是很简单，来给你们看下做出来的图是什么样的

![](img/7a3120fd4ba0cab8ee4e3807558782b9.png)

是不是感觉差不多了对吧

![](img/63744f9110503a369796dbee606cc347.png)

OK，那接下来就是文字的部分了

![](img/7c533c925b319230f1d3c2df4989432a.png)

文字在哪制作呢

在最下方的功能栏，向左滑会看到一个“文字”栏，选择它后输入“共享位置/猫捉老鼠”的文案

![](img/b62fcca363e6943ccb04089b2b2734e3.png)

然后点击颜色栏，选一个跟原图片相似的颜色，点击字体，选个方正的字体，这样会显得更好看一点

![](img/50506e19dd1cebf7b48697252c61104f.png)

这样就操作完成啦，给你们看看做成之后的样子

![](img/a3f488624ba66c565bcc66263469fe9f.png)

然后就到了中间这个文案的环节了

![](img/9217b3eae8d71ff689a639cf4d75a9d1.png)
...
![](img/46dd1e11ec427f7f72cf96db34cc2db0.png)

然后再给你们对比下原图，你们看下

![](img/7034e267dd5ace7dd2fc9487587e05ed.png)
...
![](img/b90c25c7127327226ad4da5d556a5e3a.png)
...
![](img/addefecbd37812c6526883b63087d54d.png)
...
![](img/9114669c78877339e882ff5946309b15.png)

再用这两个关键词给套进去就行了

给你们参考下我当时起的一个标题

![](img/653831236ff40e83cb2f99cae9e4effd.png)
...
![](img/fd3dd5f87c76283607892299502b5841.png)
...
![](img/57e1ed430077d885b5ed98f0f0874111.png)

然后我在他的基础上，做了一些修改，成了这样的

![](img/c907b12587c5628e9f8538b721f21fb7.png)
...
![](img/532b23edc4f2221d05df6280de750764.png)
...
![](img/be95c260d94a02f99bb2505691425984.png)
...
![](img/2d839ec6e695cd79788b541126a0cfc2.png)

没过5分钟，果然，上钩了！

![](img/efd7c8d05ca467b04ffdcfeb8e0dc12f.png)
...
![](img/3d470cc0f7e11e78e1b6eee02cd74b7e.png)
...
![](img/3ed7d15686f45821c0164e9936ac0a1e.png)
...
![](img/34ad90e576e433240e0e02189aae04c4.png)
...
![](img/9d1dd39dfc0da8b746c7a752618e86e6.png)
...
![](img/7b9ef36a3286a3b2892b3f1be582e220.png)
...
![](img/8fd5efae872ad18a38547c4e3ff36964.png)
...
![](img/329275493bcec3ad931e97c367f50329.png)

点创建群聊后，它会自动生成一个群聊的，你再点击右上角的“设置”，编辑好你的群名后

![](img/bbe2b538a67f7f51aef1551264a3d259.png)

你再点击➕号，把这个群聊分享给你的客户，他们就可以通过你分享的链接，进入到你这个群聊共享位置玩游戏了

![](img/653a8f53c82c33ce42bba7ee742a8377.png)

是不是很简单，也给你们看下效果图吧

![](img/be033ea51bac5760f4f69654f985ec49.png)
...
![](img/923f7d9dfe2673d7d0dcb77c14fe89c2.png)
...
![](img/dba05247e1604d13283c8e339b889a11.png)

意外的结果估计你也想到了吧：没一个人愿意跟我合作！

而且，他们还说了一个不起眼却很重要的冷知识

![](img/bffceaa77898c7850dfef6ee19508673.png)
...
![](img/a42d5cf7fc5d7d750932d099bfd977b9.png)

这时候我是有点想放弃的打算了。但心有不甘，于是我就发了下面这段话

![](img/554952a60e62e1c1c8333ee06683bf18.png)
