...
> 来源：[https://fieghf3pzz6.feishu.cn/docx/Xr3ddEQwXorWJpx9rcRcTZO1nXf](https://fieghf3pzz6.feishu.cn/docx/Xr3ddEQwXorWJpx9rcRcTZO1nXf)
...
![](img/6fce5c7dff31d53ea5279d44ebcae08a.png)
...
![](img/32c0cebaa6ebb793783d71298b5fe8c3.png)
...
*   选题潜在阅读人数众多，涉及每个有父母的人。

*   切中普遍恐惧点，触动大众对于孝顺的担忧和自我审视。
...
![](img/41ea783fba77cf4532749c6d7e7d45c0.png)

### 2、将文章提纲方法论转换为prompt，我们输入文章主题，GPT输出3个基于常见框架的文章提纲，举例见下图:

![](img/64471d3a6c4c7b2c42dd5e75910a4fe2.png)

### 3、根据自己想写的方向，选出文章提纲，

现在以第3个同维度并列拆分

*   社会变革的影响：现代社会发生的巨大变革，如工业化、城市化，导致家庭结构和角色发生改变，从而影响了孝心的表达方式。

*   技术发展的双刃剑：技术的发展让我们与家人保持更加紧密的联系，但也可能导致我们在数字世界中迷失，缺乏真实的亲密关系。

*   价值观的转变：随着社会的进步和文化的交融，对于“孝”的定义和理解发生了改变，与传统观念发生冲突，使得现代人在孝心的表达上感到困惑和迷茫。
...
![](img/1ec596c4c646f6ef8c5e5eff5bc1f6b9.png)

### 2、将标题方法论转换为prompt，我们输入文章主题和提纲，GPT输出5个主标题供我们选择，举例见下图:

![](img/5ad0126f695bfa6848704bbc7999a1d4.png)

### 3、从学习写作书中提取小标题的方法论：

![](img/efdf0bb0e26b8fbd703c0de12d7a4c64.png)

### 4、将小标题方法论转换为prompt，用户输入文章主题，GPT输出3个小标题，以同维度并列拆分的3个观点举例，见下图:

![](img/ae6eda9167328b7e5a42edbff6fc6114.png)
...
![](img/9719050af90fce374a7b952c476fd604.png)

### 2、提取的正文方法论转化为prompt后，生成的文章效果并不理想，后来发现prompt中并没有作者的写作风格。

学习写作这本书有个遗憾的地方，就是只解释写作的基本原理，并没有详细解释不同作者之间的写作风格，而写作风格又是区别作者的一种符号，反映了作者的个性、情感和观点。

### 3、我理解的写作风格是作者常用的语气、用词、句式、修辞，因我的写作时间短，自己的写作风格还不确定，所以我用逆向prompt工程将别的作者风格复刻下来，用来举例扩写文章正文。

### 强烈建议圈友，刻意锻炼自己的写作风格，而且要做到风格多变，这或许就是以后写作分水岭

![](img/56fd0e818e461a002d6b13eecff9bea7.png)
...
![](img/a1c4b08d2405790e5bbd29aaec043aa3.png)
...
### 4、将提取的逆向提示词，删掉特指原文的内容，加入我们要写的文章主题内容，再进行文章扩写，将生成的正文内容复制粘贴到飞书或者word文档上，见下图：

![](img/30695df6cde00d13157edab98ee2cbd8.png)

### 5、修改小标题内容，使用同样的提示词生成剩下2个小标题的正文内容，将文字复制粘贴到飞书或者word文档上

![](img/997745dc1bfa9b5477f220c5d9819f23.png)

![](img/3fde0df84249a1765e15080de5b2b0fa.png)

## 五、GPT辅助扩写文章开头

### 1、从学习写作中提取文章开头方法论：

![](img/3660dc4e9640ae9e4606627d9a8974f9.png)

### 2、将文章开头的方法论转换为prompt，我们输入文章主题和提纲，GPT输出3个不同风格的开头供我们选择，举例见下图:

![](img/28dd5195de02cc72fbfeaca10db69cc2.png)
...
![](img/babe35b282111762077f389928ac4d6d.png)

### 2、将文章结尾的方法论转换为prompt，我们输入文章主题和提纲，GPT输出3个不同风格的结尾供我们选择，举例见下图:

![](img/1cb6d25f8e30d748c087d2581b2152e9.png)
...
![](img/fd14888ac399a23c79953e7d5d3469c3.png)

### 2、将评价文章的方法论转换为prompt，我们输入文章初稿，GPT输出修改意见，举例见下图:

![](img/67bd66541c4004a07ea281c2ad182138.png)

![](img/d1e26fdf0f8acf24639fa435cff770eb.png)

![](img/f67ad99d6b29382b87a1abde04507b1e.png)

### 3、根据评价修改文章，举例见下图：

![](img/941014dded7ec115f36bdcb4eef2bcb4.png)

![](img/5eac7ba2ac3e1c0575f968a81e8f8154.png)

![](img/3a45051569f5548c9a4bdd8151d96afb.png)
...
![](img/1880e3df3ab2a4be14e2142c88f43eb9.png)
