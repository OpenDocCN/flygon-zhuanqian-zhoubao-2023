# 零基础上手影刀RPA：15分钟抓取200条小红书笔记，解锁电商自媒体自动化操作

> 来源：[https://ih195hg9y3.feishu.cn/docx/O6v0dOMabodxuxxNQGdctnnun3f](https://ih195hg9y3.feishu.cn/docx/O6v0dOMabodxuxxNQGdctnnun3f)
...
*   内容发布：小红书图文/视频内容批量发布，其他有网页版的平台同样适用

*   销量追踪：小红书店铺商品销量抓取，辅助进行选品和调整运营策略

*   获取联系方式：指定关键词的TikTok/INS网红主页信息抓取，可以拿到网红联系方式做邀约

*   微信端内容抓取：在微信搜一搜里按关键词批量获取公众号爆文或最新发布内容

*   软件操作：以微信为例，批量添加好友/导出通讯录/群发图文信息/群成员去重

*   AI联动：自动操作ChatGPT、MJ或SD等AI工具，批量生成内容

接下来我们要分享的攻略，就是从零基础开始，搭建一个自动抓取小红书笔记内容的应用，完整版的运行效果是这样的：

![](img/8bf5cdaf1f2b18d64536ed2311e7b8d5.png)

![](img/26ec0d5f590fa7927b79025328a35d94.png)
...
![](img/ce2cee95c3a970d293e7d3f855840b3a.png)
...
![](img/30e10a09c955554bc23a3089b99c57b2.png)
...
![](img/97d1fb7d4bd13ad1b3bfc7085c63574e.png)

### 创建应用

第一步就是先创建一个新应用，在左上角点击“新建”——“PC自动化应用”后会自动进入编辑页面，然后就能看到应用编辑界面。

![](img/ccb79769434677597397d0726547d9aa.png)

![](img/3ddc43fc7393d74a7d5b98a3f4900849.png)
...
![](img/d477caca236cf3d559ba4f65ee263a0b.png)
...
![](img/3fe78cb7ee198585a3a07b2b55702f7b.png)
...
![](img/7846c427ebe266d4279ae706b8f1115a.png)
...
*   循环：处理重复的操作，按设定的次数，或是制定的一个列表，逐个进行操作。

*   分支：进行条件判断，满足条件就执行A，不满足就执行B或啥也不干。
...
![](img/85847fa3c6635cfb854e8da27827fb5f.png)
...
![](img/4705710e3e6289707d139f2163177f1c.png)

常用的循环、列表和数据表格相关的指令做了标记，在用到指令但又想不起来在哪时，可以在指令上方的搜索框里输入名称，就能快速找到

![](img/cd2fd6cf8eead70e8361a4d516f0645b.png)

![](img/be35c2c68153cbce7e1fa0c0565c0565.png)

![](img/c963c163022197207d333fa410495ba1.png)
...
*   抓取一个页面的部分跟上面是一样的，这部分不用改动。

*   先获取搜索页面内所有笔记链接，再通过打开链接进入每个笔记中。

*   获取笔记链接，需要用到影刀自带的“数据抓取”功能，在应用编辑页面顶部功能区可以看到，使用方法可以按提示操作，这里放出这部分的示例截图：

![](img/90a2a7cad4f6f4a8addef53da28b8f90.png)
