# AI头像定制保姆级教学，接单收徒日入300-1000+

> 来源：[https://ixy2s5ruvqf.feishu.cn/docx/D3fcdPXdHo14mlxUv7UccoFxnbd](https://ixy2s5ruvqf.feishu.cn/docx/D3fcdPXdHo14mlxUv7UccoFxnbd)
...
![](img/2c97df30fc0bb03e029dc62e3ce201ce.png)
...
![](img/7d61a83dc4058833dda162ceb4779a9f.png)
...
![](img/18ec3b3c2f4cce48b2a325f834a71fc7.png)

![](img/f3415a473db8d2d40506cc51bd3d63fb.png)

3、进入账号之后，点击左下角的加号，创建自己的服务器。

![](img/2c07197a9b421cfa2bd82d75d47d92d8.png)

4、我们这个时候就进入了自己的服务器，然后点击左下角的导航图标，进去之后，选择Midjourney社区

![](img/1b3479d78f27df93471737213391a0d4.png)

5、当你第一次进去的时候，右边是不显示列表的，这个时候我们点击右上角的人物图像，这个时候右边就会有列表，我们点击Midjourney，添加Midjourney机器人，安装到我们的服务器。

![](img/55c8d500b8abaa453e3fba219b78ef73.png)
...
![](img/55eb378c36d3f6a6c2152215fff41106.png)

![](img/8fb6f4447e70d7a6beaeb0240bd965f5.png)

![](img/d5faaa23de2851e5e04dc3ff7255ff03.png)
...
## 第一种，客户无要求，仅做个人头像的。收费30元一张。

因为我们是做头像的，只需要客户提供半身正面照片即可，尽可能的背景干净，不干净问题也不大。

这里我就拿我的头像（偶像）照片举例。

![](img/6f062ec3f30d9796987af714cb99b6ef.png)

1.点击+号，选中上传文件，找到我们要上传的图片上传

![](img/8b654dc271d40535a0be8d6b256fe774.png)

![](img/1aed7bc156a2b98d4f380cd25a6c1d0d.png)

2.图片上传后，左键点击图片，放大图片，右键点击图片，复制图片链接

![](img/b1701bd7707ef440ff933d835c27c51a.png)

3.在空白处输入“/”，选择imagine，在右边空白粘贴你的图片链接，记得把png或者jpg格式后面问号到最后的都删除（如下图标记），然后再按空格，再输入如下描述语。按回车，等生成一组类似的图片

![](img/a6e74d255d448b19758d2b0d3b78296f.png)

![](img/c631df722bfacbf497a6f7337d091846.png)
...
![](img/c575b778af2b1f5b457752ed2ada913f.png)
...
![](img/6396bb28fccc64853a29fc1bcdb074b4.png)

5.这里我又点击刷新生成了新的四幅图。决定用第四章图片生成我想要的结果。

我按V4，进行根据这副的整体架构，再生成四张图片。或者直接按U4，生成第四张图片的高清大图。

![](img/a7d8eb57088ddcfb11469648f75909d7.png)

6.现在以上图大图为例继续操作，现在这样会已经很精致了名单时和原图是不像的，我们要继续操作，让图片变成和我们真人图很像的程度。

我们在空白处输入：/saveid，按图示，输入和导入图片。按回车

![](img/a163736ae6041619b496b9fdaaa1668e.png)

![](img/e76b8b3ae574e604a40995f703240e19.png)

7.收到如下图提示后，右键点击上面生成的大图，选择APP——INSwapper

![](img/c1f0189a55375c3a2b2a70bb729c1140.png)

![](img/7e734bc108d3c40150e7cafbf8d30b3f.png)

8.这样我们就生活称号了一张和真实图片非常接近的一张定制头像了。如下图对比即可。

![](img/f30f044f9f1e1218f384d084a13d5408.png)

![](img/2b9de080501d56005122c082271b104a.png)

9.大功告成，这个时候抓紧拉着你的亲戚朋友，老公老婆过来看看你的美美的靓照吧。

## 第二种，客户有自己要求，收费高。这种一般按工作量收费。50-100不等。
...
![](img/a14f57b844dfe4b3b678b64a1566d079.png)

2、按照客户的要求在左侧输入描述语，右侧可以选择适合的词组。

3、然后将生成的英文描述语复制到MJ。如下图操作。注意这里没有垫图（上传图片），我们这里根据客户的需要让MJ给我们生成了一副图片。

![](img/56692a71a02cd1ae044d43ccc0f52669.png)

4、知道生成一幅合格的图片

![](img/0dc1957e25a5846e808088a400761dbf.png)

5.我们以第3张图为例，在点V3，生成四张和第三张图风格类似的图片。

![](img/caf354c8451a3d314d2fc0aff9529f86.png)

6.再以第二张图生成最终大图，按U2

![](img/d31eacb7a2121780a8e8c700633bc2e4.png)

7.我们再用saveid指令，把脸部换成我们客户的脸部。

![](img/785edf4e0d591979abd86c3eeabf9fec.png)

![](img/a9e4c64262e5c2b71a1dc60e6fa70ed7.png)

![](img/7f6d0ecf4e0a044f5bd182d85771d059.png)

![](img/534c82533306fd0e8f15fbf966ceccbd.png)

# 四、图文的制作和发布

一般笔记图文的发布很简单，就是以原图和效果图合成一张图片，展现在各大平台，这样客户看到也知道你这里是可以定制的。

![](img/0af6ab021675bc5a83b218d07f5dd84f.png)

![](img/06cf34e2a9b51dd5f4e283af113ca851.png)

![](img/07ed513eb432c787a93a2db271d372ee.png)

具体操作：

手机下载美图app，点击模板，里面有很多模板可以使用，我这里选择朋友圈背景为例

![](img/07046ab26f965a01bb60fbd0e1af23b4.png)
...
![](img/c48851368d0e9f545a88b4c706ecebd2.png)

![](img/d6a69b82a61f54ba680d50470e48744a.png)
...
## 云天AI头像保姆级教学，点击链接即可保存。

## 链接：https://pan.quark.cn/s/7a10aaafef3d

![](img/1f55a8ab44282fb2edf2fc0728da6929.png)
