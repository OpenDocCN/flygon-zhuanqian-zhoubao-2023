# 单篇阅读23w+！AI数字人项目，0基础做视频号8天起号！我是怎么做到的？

> 来源：[https://pzt1wh07h5.feishu.cn/docx/BqjudGNyKo6Mi8xOVdccI5Arn3b](https://pzt1wh07h5.feishu.cn/docx/BqjudGNyKo6Mi8xOVdccI5Arn3b)
...
![](img/63d45dbcdc68c6d66a13ccef769a2cab.png)

![](img/80e12e311c4b9ca320a00045fc1df3d4.png)

![](img/777a88aa3cab5ffb33f46584ad5c7782.png)

999+以后，会显示...。

![](img/5421b470376f1bfba10effcbcc070459.png)
...
![](img/a97ca47608d49451706f8e26152e8e01.png)
...
![](img/c389e8e64c93b0d07714de288b95ca1d.png)

![](img/2684dd05b281968a31f9644449ce0573.png)
...
![](img/c9355b0c778f6c7f54223a024130704a.png)

![](img/e264269703b5d6530e063160c3de483a.png)
...
![](img/cf1a2138b35e805bbc123093055437b0.png)
...
![](img/0dfde98eb949ef3408f5835420621564.png)

![](img/71ae749f580d7b40370e7286641f3baf.png)
...
1.  通过飞书-视频会议-妙记功能。它可以识别视频中美女数字人说的文案。点上传，识别完成后，导出文字记录。

![](img/99d9c607c7d0eea663b305d6c46139b3.png)

![](img/bac5ea1fe61c05f7010a823544438d56.png)

1.  剪映智能字幕功能。如果妙记识别的缺少，比如，一个20秒的视频，识别出来的明显就10来个字母，就可以借助剪映的文本-智能字幕-识别字幕来做了，导出txt，即可。
...
1.  首先把刚刚3.3弄好的中文文案直接拿过来。

1.  拿着这句话，直接在抖音或者百度搜，就能搜到一大堆相关类似的文案。比如这个，拿捏男人的秘诀。

![](img/2cf51dd7fb90b07a717bf8a0c07365f5.png)

1.  在中间增加8~20个字的中文文案，或者替换其中的几个字的文案。

1.  在百度对你增加或者修改的这句话做翻译，得到英文文案，放在对应位置。

1.  注意文案总结里包含数字的（比如，命好女人的n个特征），如果你增加了条目，记得改下数值，否则影响后续的进行，比如，后续数字人生成的这个数字，也有问题了，那就浪费积分了，对吧。
...
![](img/fcf6e3d6b551884eabc45d7f6a6d5a4b.png)

![](img/58061a3190bdfdd725744a6271e4330b.png)
...
1.  导入生成好的数字人视频，裁切掉logo，设置9:16的比例，调整人物大小，位置。

1.  如果在heygen没选择背景，就对人像做智能抠图处理，并设置一下背景，可以用纯色，渐变色或者你上传一个图片，尽量和对标风格类似，不要太过大红大紫大绿，简约就可以了，否则就影响读者的体验了。

1.  增加英文字幕。文本-智能字幕-文稿匹配，把刚刚我们做好的文案，放入进来，等待识别成功。看下有无截断的短句，我们需要手动合并处理优化一下，否则后续中文字幕的还要再处理一遍，就更麻烦了，处理好以后，导出字幕。

1.  增加中文字幕。画面上是中英文字幕的，中文字幕，如何加呢？如果一个一个去在英文字幕上一个一个去加中文字幕就太麻烦了，且容易弄错。
...
![](img/41353fbf7e2006ee7177278c63d2b150.png)

1.  回到剪映，删除原来的英文字幕，导入刚刚做好的中英文字幕。

1.  整体修改中文字幕的样式，与对标尽量保持一致。

1.  整体修改英文文案的样式。与对标尽量保持一致。

1.  首屏标题的样式。（是否需要根据对标来，有的有标题，有的就是文案第一句话。）

1.  增加背景音乐。近期很多账号比较常用的是，eyes for you 纯音乐。

1.  修改视频音量，背景音乐音量。多尝试对比，与对标保持一致。

1.  整体过一遍效果，还有无差异很大的地方，做修改，比如英文覆盖着中文了，那就整体把英文整体下移一下；看人物底部是否会透漏出背景色，之类的，调整人物。

1.  做去重处理。去重技术，我用的是手机端的画中画，模仿优质对标，在底部增加动态视频的方式，让主播和这个动态视频融合一下。
...
![](img/10877378abfaac44cbf88b383b574392.png)
...
![](img/815113bab6c5167457a5d22ca2f210fb.png)
...
![](img/4593bae62806c4aa8964f4488e090581.png)

发自内心：感谢我的教练，他擅长规划全局，我擅长执行，我做的每步，他几乎都要把关，谢谢他的严格，就这样把账号很快起来了，感激涕零！

## 选择项目，最好选择自己感兴趣+有积累+有清晰变现路径的。
