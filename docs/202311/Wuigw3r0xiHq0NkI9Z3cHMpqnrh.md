...
> 来源：[https://t3vl04fm23.feishu.cn/docx/WXfLdq9gDoVnwTx9MP9coSlTnJe](https://t3vl04fm23.feishu.cn/docx/WXfLdq9gDoVnwTx9MP9coSlTnJe)

# 一.最王炸的变化——人人都能有的定制gpt
...
![](img/14da73f8581d3408d75c61251481e244.png)
...
![](img/ed87b017cfb0ac1e1010273f3e4898d4.png)

# 二.create a gpts

## ①初始界面介绍

![](img/62ea6087318f41063507f0cd2086c4f9.png)

*   Name（名称）：给gpt起个名字

*   Description（描述）：添加GPT用途或功能的简要描述

*   Instructions（指示）：在这里，提供关于GPT应该做什么、它应该如何行为，以及应避免做什么的指导原则

*   Conversation starters（对话开始者）：通常用于输入建议的提示或话题，以启动与GPT的互动。

*   Knowledge（知识）：包括一个上传文件的选项，GPT可以使用这些文件来定制其知识库或回应。

*   Capabilities（能力）：复选框表示可以为GPT启用的不同功能，如网页浏览、DALL-E图像生成、代码解释等，这些都是gpt4的默认功能

*   Actions（行动）：添加GPT可能执行的自定义行动的区域，可能通过集成或专门的命令
...
![](img/a3ae9bdcb117c1815bb016f01fb58ae3.png)
...
![](img/d6ac6d0034df6d9c1d4bdd93969a83fb.png)
...
![](img/e3f3170ab3a6cf367d3fe60611ea36ce.png)
...
![](img/b6845b156e86628a6e051c5e30eb68cb.png)

### (2)案例投喂

这里使用了八爪鱼采集器，爬出了优质标题库的excel

![](img/19a2c6e7916ca455e28a0ceb7baa1df6.png)

第一栏，有大量的对标爆款标题，复制过去，让它进行学习

这里不使用excel的根本原因是，让它自己分析excel比较复杂，比较慢，不如直接投喂文本资料快

![](img/2efe0d17411ff569e3f569b9a49a7667.png)
...
![](img/63c86e5fe14ed476a5aaf93ee13b79fd.png)

这些上传过的资料都被留存在knowledge里面，时刻影响着模型的决策

比如我自己有学雅思的需求 我把雅思资料全部传到里面，就可以帮助我进行学习

![](img/2cb16683266ed724dfea62a136523a29.png)
...
![](img/badb0272023477464dc4f837fbe61035.png)
...
![](img/66bfe1d6d596b32bbe987651174ec633.png)

*   Only me: 只有自己可以使用.

*   Only people with a link: 通过分析的链接可以访问.

*   Public: 所有人都可以访问， 但是需要开启个人名称、并且绑定公共域名

点击confirm，开始进行对话和使用

![](img/eab1ab0853ebf9b3869064b53159f943.png)

## ⑦使用界面介绍

![](img/d2a967484790a807fc71a807adc18a7d.png)

*   New chat: 启动新对话

*   About: 个性化你的GPT的信息

*   Hide from sidebar: 对左侧导航栏进行隐藏

*   Copy link: 复制分享链接

*   Report: 出现问题后，给官方发送该 GPT 的异常信息
...
![](img/e11ca1964f10de0687fc3d39e04c1c74.png)

直接跳转到新的页面，输入语言-中文

![](img/8ee372ed5163b4fcdd0582e4088f465f.png)

我想学youtube运营 输入/plan 它给了我一个学习计划

![](img/eaf5a552a23b677b561e5b9aaccb868d.png)

开始给我进行讲解

![](img/de66f57cdb4854518fc365c692464deb.png)

最重要的功能：考试 输入/test 进行一些有趣的考试

![](img/14b32a30aab9ad6dc851f029bfba524a.png)

![](img/df638b803eeb972fee9a9ebfaeeabe9c.png)
