# 【实战】效率神器：ChatGPT和Zapier实现自动化！

> 来源：[https://zzi7a49xoa.feishu.cn/docx/H4L5dC5VFozWrlx6sI7cmnRpn8e](https://zzi7a49xoa.feishu.cn/docx/H4L5dC5VFozWrlx6sI7cmnRpn8e)
...
*   提高效率：自动化重复性任务可以大幅节约时间，让用户能够专注于更重要的工作。

*   减少错误：自动化流程可以减少人为操作错误，确保数据的准确性和一致性。

*   定制和灵活性：用户可以根据自己的需要定制 Zaps，实现高度个性化的工作流程。

*   提高协作效率：Zapier 可以帮助团队成员共享数据和通知，从而提高团队合作的效率。
...
![](img/72eb8ccc2fee14ec1229d179b6894c50.png)

输入简单个人信息，点击 Continue。

![](img/55b313fd1358cff791dc1325206bdda0.png)
...
![](img/280c79b7dd1cf695da9e659dc902f19d.png)

目前国内支持的软件较少，相对著名的国内办公软件里 我看到了 Tencent Docs。

![](img/c60eb37ce9fb75d06d089a91b7cf4074.png)

### 二）配置 GPTs

1、点击 Explore > Create a GPT，来到配置页面。

![](img/6de1578bf65df12deb6a1be2f5cb0c0b.png)

2、来到配置页面， 点击 Create new action。

![](img/1a4b62d3d5e8c4ec7d469e68f5caa830.png)

3、配置 url 并点击 Import ，再配置 Privacy policy。

1.  url : https://actions.zapier.com/gpt/api/v1/dynamic/openapi.json?tools=meta

1.  Privacy policy: https://zapier.com/legal/data-privacy

![](img/b9dc619d87771e9040aafb5b1386a3d2.png)

![](img/e15388747d1d9dd7a07e1bab6c1ceb29.png)
...
![](img/55a60f2e1b949ccf8f76cbdea17b3fd5.png)

6、输入 配置zapier，开始配置。点击 Sign in with actions.zapier.com 进行登录

非开发人员忽略这段话：在配置状态下测试时，默认将显示Debug模式，既可以看见接口之间请求和响应的日志信息，。

![](img/061a54f54a76f2076908844758945223.png)

7、点击 Allow。

![](img/0e4fa75498c168d2ed21ab42c8c7cdde.png)

之后，页面会自动返回，然后你可以看到成功提示。"You have successfully signed in via OAuth"

![](img/f5578b736f546795a461ff2e5ab727bd.png)

8、输入 请列出我可以配置的 Zapier AI Actions，并使用中文和我对话 , 点击 配置 Zapier 的链接.

![](img/ed41350c5e02165e123bae1bc9959bca.png)

9、在链接中, 点击右下角 Add a new action. 这里, 接下来将使用 查看邮件 的功能来演示。

若之前没有登陆,这里会要求先登陆。

![](img/c14a8bd2822859e47fd842d1589ada4e.png)

10、搜索 查看邮件 的功能。输入关键词 Gmail，找到 Gmail：Find Email 选项。

![](img/330e006dec67bb42d5cab61552454a7c.png)

11、点击 Connect a new Gmail account，并绑定邮箱。

![](img/5dedd93532da28fd267c29547164705f.png)

点击 Yes，Continue to Gmail。

![](img/fde9429dbe582b724d7f27bdb49b8b6a.png)

选择邮箱账号。

![](img/85d2048afe593fe647a3f5bbb72859f7.png)

点击允许，进行授权访问邮箱账号。

![](img/f20377f713f906c41a648a5834434154.png)

12、点击 Enable action。

![](img/79113e42f9f2b0b4ede51483a6c9485c.png)

这样代表已经启动了，如果需要添加其他动作，可以点击 Add a new action 来操作。

![](img/b79e6fe4ee71fac8fe30cc1e1bd95eab.png)

13、回到 GPTs 中，回复已经完成。

![](img/29aef16896e32b7871bd0753c9a48e06.png)

### 三）简单测试

1、要求小助手列出过去一周关于 AI 的邮件。在处理指令时，会要求用户确认是否信任对应的网站，可以点击 Allow 来授权。

![](img/bcdd0c04a57883226cdcde0c8ad9d844.png)

2、输出结果基本满足要求。

![](img/6604cf8abc9caf8f13643c296b21ba80.png)

3、指定时间，针对邮箱内容进行简单的汇总。

![](img/dd1a2bc846964445f842b5a96f60abdd.png)
...
![](img/be845ddb59d203a94f609750670118e6.png)

2、登录成功。

![](img/c4525b2860c21da9277e1da5f60cf932.png)

3、先了解目前该账号已经配置的 Zapier AI Actions，来判断是否需要 配置额外的动作来满足需求。没问题后进行下一步。

![](img/8b140cdda5caf236df02ff9e20867a36.png)

4、输入提示词，将项目相关的邮件进行汇总，并输出项目汇报相关邮件的 “当前状态”、“主要问题”、“下一步计划”。

![](img/a32cb2a1696942a31b4906cefec3fba8.png)
...
![](img/130347c634195930ff74db9f2cc5a274.png)

2、点击 Sign in with actions.zapier.com 后在新窗口点击 Allow， 进行初始化登陆。

![](img/2cb810ddfbeb37646e09a0905a876841.png)

3、重新获取可以操作的动作。

如果没有 Reply to Email, 可以参考 三、操作流程 / GPTs 章节添加 Gmail：Reply to Email 的动作。

![](img/ee0ee48854b16f75436cd5a2360f06f2.png)

4、获取昨天的邮件简要汇总。

![](img/2ec44fc68c440c2cf7268bf046505947.png)

5、自动分类并生成对应的回复建议。

![](img/f9974f49c564dac9b6df9aba36d37894.png)

6、将生成的内容自动回复给发件人。

![](img/9ef5f9efda4ff5df6d1864bf7c289b4b.png)

7、检查邮件，发现回复正确。

![](img/6ef7c5c8bb220b3661083d490a3c77eb.png)

![](img/fd7e688aa0895e272c3cad58eef92d69.png)
