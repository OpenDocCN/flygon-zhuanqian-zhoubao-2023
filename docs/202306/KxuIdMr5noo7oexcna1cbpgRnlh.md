...
> 来源：[https://fs4xcvw5u9.feishu.cn/docx/KxuIdMr5noo7oexcna1cbpgRnlh](https://fs4xcvw5u9.feishu.cn/docx/KxuIdMr5noo7oexcna1cbpgRnlh)
...
![](img/10ede508862be380614c253cb40885d9.png)
...
1.  问题要结合用户习惯的场景开始谈，可以首先安排用户简单自我介绍；

1.  问题先从简单的开始，逐渐深入，要合适的过渡；

1.  问题设计不能含有暗示或诱导的方式，问题要保持客观中立，不带情绪；

1.  问题的表述要符合用户的认知，尽量避免专业词汇；

1.  问题将你想获得的信息都覆盖之后，就可以收尾结束，常规访谈15-30个问题的篇幅是比较合适的；

1.  要写好访谈开篇介绍，和结束的感谢，让用户感受到重视和尊重；

二、邀约访谈用户注意事项

1.  访谈对象的情况，要和你将来预期的用户是差不多的，不能毫不沾边，也尽量要涵盖更多类型；

1.  邀约时，将访谈的目标、大概过程、要占用的时间告知对方，优先选择感兴趣、愿意配合的用户，尽量不要态度勉强的，提升访谈效率；

1.  提前告知一些要点，比如采用的方式是线上or线下；为了方便整理过程会有录音；访谈结果会去掉敏感信息等因素，让用户提前知道受访的权利和义务；

1.  如果是相对陌生的用户，可以在邀约时，收集一些该用户的基本信息，职业、年龄、相关习惯等，作为采访之前提前了解的背景知识；

1.  和用户约定好时间后，最好有一个提前提醒的机制，避免用户忘记约定；

1.  一个主题邀约6-10人即可，新手可以过程中持续优化访谈稿；
...
1.  访谈要严格遵守规定时间，如果需要超时，提前征询意见

1.  尽量不要对用户的回答进行评论

1.  过程中不要带有预设的立场，尊重用户的任何反应

1.  专注聆听，注意用户的回答，做好信息的确认或者追问

1.  对于容易跑题的用户，要控场，及时提醒并问清楚问题

1.  注意自己的语气和情绪，让过程更轻松和自然

1.  确认信息时，重复用户的原话确认，尽量避免自己调整内容

1.  用户流露的情绪和感受，在录音中无法体现时，要做好笔记

1.  在现状、目标、卡点这三个部分，注意对用户痛点要敏感，且恰当追问到了解清楚。
