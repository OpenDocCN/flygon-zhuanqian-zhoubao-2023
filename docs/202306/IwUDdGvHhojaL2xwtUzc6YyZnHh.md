...
1.  通过这种方式获取到的数据可能更适合一些直接在小红书店铺中直接转化的产品，这种产品客单价一般不会太高，而如果我们想做一些高客单价的产品或服务，那么，大概率我们需要把用户引流到私域，再进行二次转化，那么此时，我们再通过上面这些数据来辅助我们选品可能就不太合适了。

1.  上述行业类目综合评分只是从大的行业维度上给我们一些参考，并不是说竞争度太过激烈的行业就没有办法做了，针对这些竞争比较激烈的行业，我们可以利用搜索长尾词去选出一些更加细分的产品，只要需求量足够大，也一样是可以做的。
