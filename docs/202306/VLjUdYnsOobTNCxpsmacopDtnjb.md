# 如何两个月通过Ai私人部署变现73万（附：生财有术知识库）

> 来源：[https://vfqxua5lvd.feishu.cn/docx/VLjUdYnsOobTNCxpsmacopDtnjb](https://vfqxua5lvd.feishu.cn/docx/VLjUdYnsOobTNCxpsmacopDtnjb)
...
![](img/5995c4f0dbf893ed03349e9647a0ee1f.png)

![](img/ac70a5d1c17cb5aad167f02d6810580c.png)
...
![](img/5351ce3cbc308fd93d671e0aacecc1b6.png)

接入企业微信后效果如下：

![](img/73ab4dc5f17becd4cd26f7ed16700224.png)
...
1.  无时无刻的支持：这款AI产品可以24小时不间断地提供服务。无论你何时需要它，它都会在那里，满足你的需求，帮你链接信息和资源。

1.  快速获取信息：与传统的人工客服相比，AI私人部署的产品能在瞬间提供你需要的信息，而不需要等待人工处理。

1.  深度学习和改善：这款产品会随着时间的推移，通过机器学习技术不断地学习和改善，提供更准确和有用的信息。

1.  数据保密性：我们尊重知识产权，所有训练数据都来自公开的互联网信息，没有使用任何私人或敏感的数据，所以你可以放心使用。

1.  易于使用：这款产品的设计非常直观和用户友好，你可以快速上手，无需任何复杂的学习过程（打开框问就好了）

![](img/902715b5789d0cb7b65bfb1f87559a9d.png)

1.  个性化体验：这款AI产品可以根据你的查询记录和偏好，提供个性化的信息和资源，帮助你更有效地获取你需要的内容，真正 实现个性化训练。

1.  大规模处理能力：无论社群有多少人，这款AI产品都能同时处理大量的查询，提供快速的服务。

1.  有效的解决问题：如果你遇到问题，这款AI产品凭借庞大的数据库，能快速帮助你找到解决方案，提供丰富的信息和资源。

1.  成本效益：相比于雇佣大量的人工客服，这款AI产品可以提供更高效、更便捷、更具成本效益的服务。
...
![](img/7284092cc362a8c551ca8ae2e85badeb.png)
...
![](img/f56e038469a6beeeff9ac80b7b99b03b.png)

#### （二）第二步：数据清洗

![](img/bb3d5dd86e66ee3089fe6c6da33566f8.png)

数据清洗这一步是比较关键的一环，我们针对现有的数据做了以下处理：

1.  去除无用信息：首先，我们需要去除那些对分析没有任何帮助的信息，例如HTML标签、URL、数字（除非它们在你的情境中具有特定含义）、特殊符号等。

1.  分词：这一步是将文本分割成单词或者词组。这一步就比较复杂，因为中文的词没有明显的分隔符，所以当时做这一步费了很多的时间。

1.  去除停用词：停用词是那些在文本中频繁出现但对分析并无实际意义的词，例如“的”、“和”、“是”等。去除它们能帮助我们将注意力集中在真正有意义的词上。

1.  情感分析：这是一种用于分析文本中的情感倾向的技术。它可以用于分析生财公号文章中受邀嘉宾们的评论、反馈等。

#### （三）第三步: 数据标注

处理完的数据要做数据标注，便于我们的LLM 模型能够准确识别，下图是我们用new bing做的关键词标记，不得不说联网功能方面new bing 是更胜一筹的。

![](img/e58578b7a60915a57387cfad13515ccd.png)

除了关键词标注以外，我们针对以上的素材还做了两方面的标注：

1.  实体识别：这个过程通常涉及到标注文本中的特定实体，如人名、地点、公司名等。通过这种方式，模型可以更好地理解这些实体在文本中的角色和意义。

1.  情感标注：在这个过程中，标注者会对文本中的情感倾向进行注释。例如，一段文本可能被标注为"积极"、"消极"或"中性"。
